...
<body>
    ...
    @foreach($all_category as $v_category)
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{$v_category->category_id}}">{{$v_category->category_name}}</a></h4>
                            </div>
    @endforeach
                        </div>
    ...
    @foreach($all_manufacture as $m_manufacture)
                            <div class="panel-heading">
                                <h4 class="panel-title"><a href="{{$m_manufacture->manufacture_id}}">{{$m_manufacture->manufacture_name}}</a></h4>
                            </div>
     @endforeach
                        </div><!--/brands_products-->
